          ...
          <div class="container bg-white shadow" data-aos="fade-right">
            ...
            <div class="row my-5 mx-auto" data-aos="fade-left">
              <div class="col-md-6 bg-white mb-5">
                ...
                <button class="btn btn-success btn-block mb-3" data-toggle="modal" data-target="#upload_bukti_tf">Aktivasi Akun</button>
              </div>
              <div class="col-md-6 bg-white mb-5">
                <img src="{{asset('img/test.png')}}" class="img-thumbnail img-fluid w-75 mx-auto my-3 d-flex justify-content-center" alt="foto"><br>
                <a class="btn btn-info btn-block text-white mb-3" href="/user/view/test">Ambil Test</a>
              </div>
            </div>
